                    ...
                    <form method="POST" action="{{ route('profile.update') }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email" class="form-control" name="email" placeholder="examplo@examplo.com" value="{{ old('email', Auth::user()->email) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="confirm_password">Confirme a Nova Senha</label>
                                        <input type="password" id="confirm_password" class="form-control" name="password_confirmation" placeholder="Confirme a Nova Senha">
                                    </div>
                                </div>
                            </div>
                        </div>
